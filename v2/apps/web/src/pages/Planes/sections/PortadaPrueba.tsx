...
export function PortadaPrueba() {
  return (
    <section className="mx-auto max-w-[1440px] px-10 pb-12 pt-16 max-[560px]:px-5">
      <Kicker className="anim-fadeup mb-4">La prueba · {PLAN_COUNT} planes · un solo autor</Kicker>
      <h1
      ...
      >
        ...
        hombre gris cualquiera. Cada uno parte de la misma pregunta: si esto se pudiera diseñar de
        cero, ¿cómo sería? Y del mismo método: primero el ideal, después el camino de vuelta.
      </p>
