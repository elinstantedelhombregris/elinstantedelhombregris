...
export function PortadaPrueba() {
  return (
    <section className="mx-auto max-w-[1440px] px-10 pb-12 pt-16 max-[560px]:px-5">
      <Kicker className="anim-fadeup mb-4">El ejemplo · {PLAN_COUNT} planes · un mismo método</Kicker>
      <h1
        aria-label="Primero el ideal. Después el camino."
        className="font-anton riso-hover mb-5 text-[clamp(44px,6vw,88px)] leading-[0.98]"
      >
        <RitoTinta lineas={['Primero el ideal.', 'Después el camino.']} />
      </h1>
      <p
        className="anim-fadeup text-tinta-75 max-w-[640px] text-pretty text-[17px] leading-[1.6]"
        style={{ animationDelay: '0.9s' }}
      >
        {PLAN_COUNT} planes de país — salud, escuelas, tierra, moneda, justicia. Cada uno sale del
        mismo proceso: en vez de preguntar qué se puede arreglar, se pregunta qué construiríamos hoy
        si empezáramos de cero. Recién después se busca el camino de vuelta, desde ese ideal hasta el
        país que hay.
      </p>
      ...
      <div className="border-sello anim-fadeup mt-9 flex flex-wrap items-center gap-7 border-2 px-8 py-7">
        ...
        <p className="text-tinta-90 min-w-[280px] flex-1 text-pretty text-[15px] leading-[1.6]">
          ...
          levantar la vara de la discusión que estamos teniendo. Son un punto de partida, no uno de
          llegada — leelos para criticarlos, mejorarlos o reemplazarlos. El programa real lo escriben
          las{' '}
