 ...
 * expedientes del catálogo: `/planes/:slug`). El Set de arriba matchea
 * por igualdad exacta — las dinámicas necesitan además un match por
 * prefijo. Excepción sancionada (spec 2.3, Decisión 10: «`PAPEL_ROUTES`
 * aprende prefijos»).
 */
const PAPEL_PREFIXES = ['/mandato-vivo/', '/planes/'];
