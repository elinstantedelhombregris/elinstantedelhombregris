---
slug: presidencia
title: Por qué los presidentes son una idea estúpida
subtitle: Un ensayo sobre la arquitectura del poder
...
## I. La herencia que olvidamos cuestionar

Toda república que se llama moderna sigue guardando un rey en el altillo. Le cambiamos el nombre. Le pusimos un plazo, una banda, un escritorio, un juramento. Nos convencimos de que la diferencia entre un monarca y un presidente es la urna. Pero la arquitectura — una persona, una voluntad, una cara en el billete de la imaginación — es más vieja que la democracia y fue construida para un mundo que ya no existe.

La presidencia se diseñó cuando la información viajaba a la velocidad de un caballo, cuando coordinar una nación exigía un único punto de decisión porque cualquier otra cosa era logísticamente imposible. Un presidente tenía sentido del mismo modo que lo tenía un telégrafo: era la mejor tecnología disponible para mover una señal por un medio lento. Desde entonces inventamos internet, las bases de datos distribuidas, el consenso criptográfico, la deliberación en tiempo real entre continentes. Y sin embargo el poder ejecutivo de casi cualquier república sigue funcionando a caballo.

Esa es la primera estupidez: preservamos un mecanismo de coordinación mucho después de que se disolviera la restricción que lo justificaba.

## II. El problema de la información

Russell Ackoff lo dijo sin rodeos: la jerarquía no es una estructura de poder, es una estructura de información. Construimos pirámides cuando la información es cara y lenta. Las aplanamos cuando la información se vuelve barata y rápida.

Un presidente es la cúspide de una pirámide de información. Toda decisión que importa en un país de cuarenta y cinco millones, o de trescientos millones, o de mil millones, tiene que pasar — por asesores, por ministros, por filtros — y caber en el ancho de banda cognitivo de un solo ser humano que necesita unas ocho horas de sueño, come tres veces al día, tiene familia, se enferma, se cansa, se enoja, se enamora, recae, envejece.

La cuenta no da. Nunca dio. Lo que llamamos "decisiones presidenciales" son, casi siempre, decisiones tomadas por personal anónimo y ratificadas con una firma. El presidente es, en la práctica, un cuello de botella con corona — y la corona es el problema, porque nos hace creer que un cuello de botella es un líder.
...
Al candidato le ofrece la droga más adictiva jamás sintetizada por la vida política: la creencia de que una sola persona puede salvar un país. Cualquiera dispuesto a perseguir el cargo al nivel que hace falta para ganarlo ya falló, casi por definición, un examen básico de cordura. El rol selecciona mesianismo. Premia a los que pueden convencer a millones de que su voluntad personal es idéntica a la voluntad nacional. Eso no es liderazgo. Es una forma particular de locura que institucionalizamos y bautizamos "ambición".

Al ganador le ofrece algo peor: la disolución lenta y estructural del contacto con la realidad. El presidente es la última persona del país en enterarse de las malas noticias, la primera en que le confirmen que tenía razón, el ser humano más rodeado de la nación, y de algún modo el más solo. Cada interacción está filtrada. Cada comida la prepara alguien cuyo trabajo depende del humor del presidente. Cada desacuerdo viene suavizado. La oficina es un tanque de privación sensorial disfrazado de trono.

Al público le ofrece el descuento psicológico más caro jamás inventado: el derecho a dejar de pensar en gobernanza durante cuatro años. Si hay un presidente, alguien está al mando. Si alguien está al mando, los problemas son culpa suya, no nuestra. La presidencia le permite a una población tercerizar su responsabilidad cívica en una sola cara, y después culpar a esa cara cuando la realidad se rehúsa a obedecer. La "delegación mesiánica" no es un bug del sistema. Es su servicio principal.

Esa es la tercera estupidez: la oficina daña a la persona que la ocupa, e infantiliza a la población que la creó.
...
Quiero ser cuidadoso acá. "Estúpida" no es un insulto, es un término técnico. Un diseño es estúpido cuando, con alta consistencia, produce resultados opuestos a su propósito declarado. La presidencia es estúpida en ese sentido exacto:

Dice concentrar la rendición de cuentas y en cambio la difumina — porque todo lo que sale mal se le carga al "gobierno anterior", a "la oposición", o al "estado profundo".

Dice habilitar la acción decisiva y en cambio produce parálisis — porque una sola persona enfrentada a una legislatura genera más fricción que la que generan los cuerpos colegiados coordinándose entre sí.

Dice representar la voluntad del pueblo y en cambio representa la voluntad del cincuenta y uno por ciento que apareció un martes — y después gobierna al cuarenta y nueve restante como si hubiera consentido.

Dice ser un freno a la tiranía y es, de hecho, la infraestructura más eficiente para la tiranía jamás diseñada, porque cualquiera que la captura se queda con todo lo que tiene atado.
...
Este ensayo abre la serie. Sus referencias todavía son generales — la figura del hombre gris recién se está introduciendo; la arquitectura solo se nombra en boceto. Las conexiones específicas con el movimiento se vuelven más densas en los ensayos cuatro a seis, donde la arquitectura se traza y la figura se materializa.
...
- *Perfil del Hombre Gris* — la descripción completa de la figura introducida en la sección VII.
- *Persona del Hombre Gris* — la voz y la conciencia de la figura, aplicadas a lo largo del proyecto.
- *Presentación de la Plataforma* — la profecía y la historia de origen detrás del trabajo.

**Continúa en.**

- *La falacia de la democracia* — extiende esta crítica hacia arriba: del rol al sistema que produce presidentes.
