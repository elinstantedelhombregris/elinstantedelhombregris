---
slug: integracion-tu-mapa-de-transformacion-personal
courseSlug: la-vision-de-transformacion
title: 'Integración: Tu Mapa de Transformación Personal'
summary: 'Poné todo junto en un mapa personal de 7 componentes. Ritual de compromiso, práctica de revisión y el comienzo real.'
orderIndex: 10
estimatedMinutes: 11
draft: false
---
