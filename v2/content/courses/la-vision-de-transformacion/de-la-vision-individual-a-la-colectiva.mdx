---
slug: de-la-vision-individual-a-la-colectiva
courseSlug: la-vision-de-transformacion
title: De la Visión Individual a la Colectiva
summary: 'Peter Senge, movimientos sociales y el proceso paso a paso para construir una visión compartida auténtica.'
orderIndex: 6
estimatedMinutes: 11
draft: false
---

## De la Visión Individual a la Colectiva
...
Peter Senge, movimientos sociales y el proceso paso a paso para construir una visión compartida auténtica. Cobra valor cuando lo convertís en una decisión observable dentro de tu visión personal y tu capacidad de sostenerla. El objetivo no es repetir una definición, sino usar esta idea para leer mejor una situación, ordenar prioridades y elegir un siguiente paso con menos improvisación.
