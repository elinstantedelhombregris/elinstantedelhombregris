---
slug: resiliencia-y-adaptacion-sostener-la-vision-en-la-tormenta
courseSlug: la-vision-de-transformacion
title: 'Resiliencia y Adaptación: Sostener la Visión en la Tormenta'
summary: 'La Curva J, Teoría U de Scharmer, crecimiento postraumático y prácticas concretas de resiliencia visionaria.'
orderIndex: 9
draft: false
cierre: completo
fuentes:
  - url: https://www.emol.com/noticias/economia/2011/12/18/517612/empresas-recuperadas-en-argentina-simbolo-del-resurgimiento-tras-la-crisis.html
    titulo: 'EFE (en Emol) — Empresas recuperadas en Argentina, símbolo del resurgimiento tras la crisis del 2001'
    consultada: '2026-09-22'
  - url: https://servicios.infoleg.gob.ar/infolegInternet/anexos/180000-184999/183856/norma.htm
    titulo: 'Ley 26.684 — Concursos y Quiebras, modificación de la Ley 24.522 (InfoLeg)'
    consultada: '2026-09-22'
  - url: https://www.presencing.org/theoryu
    titulo: 'Presencing Institute — Theory U'
    consultada: '2026-09-23'
  - url: https://www.careinnovations.org/wp-content/uploads/Post-Traumatic-Growth-Inventory.pdf
    titulo: 'Tedeschi y Calhoun — Posttraumatic Growth Inventory, ítems y factores (Center for Care Innovations)'
    consultada: '2026-09-23'
  - url: https://rascl.studentorg.berkeley.edu/assets/files/this_too_shall_pass.pdf
    titulo: 'Bruehlman-Senecal y Ayduk (2015) — This too shall pass: temporal distance and the regulation of emotional distress (Journal of Personality and Social Psychology)'
    consultada: '2026-09-23'
---
...
Cuando iniciás una transformación, tu rendimiento y bienestar no mejoran linealmente. Suelen seguir lo que se llama la **Curva J**, que no es una ley sino un mapa aproximado de lo que le pasa a mucha gente:
...
**El momento más peligroso es el punto 2 — el valle de la desilusión**. Es ahí donde más fácil resulta abandonar. Y es ahí donde tu propósito y tu comunidad marcan la diferencia entre rendirse y seguir.
...
Las investigaciones de Richard Tedeschi y Lawrence Calhoun sobre **crecimiento postraumático** ordenan en cinco áreas los cambios que reportan las personas que crecen después de una adversidad; son los cinco factores del inventario con que lo miden:
...
Cuando estés en crisis, preguntate: "¿cómo voy a ver esta situación dentro de diez años?" No es que eso «apague la amígdala»: lo que se midió es otra cosa. En los experimentos de Emma Bruehlman-Senecal y Özlem Ayduk (2015), estudiantes que pensaron un problema reciente como lo verían dentro de diez años sintieron menos malestar que quienes lo pensaron a una semana, y la razón parecía ser que el horizonte largo hace ver lo pasajero del problema.
...
Cerámica Zanón, en Neuquén, quebró en octubre de 2001 con 360 trabajadores. En marzo de 2002, 240 de ellos volvieron a poner en marcha la planta, y en diciembre de 2011, según EFE, trabajaban ahí 460 personas. No fue la única: la misma nota contaba entre 205 y 300 empresas recuperadas en el país. Ese mismo año, la Ley 26.684, sancionada el 1 de junio de 2011, reformó la Ley de Concursos y Quiebras: si lo piden las dos terceras partes del personal organizado en cooperativa, la conservación de la fuente de trabajo habilita la continuación inmediata, y los trabajadores pueden pagar la empresa con los créditos laborales que se les deben. Es la visión flexible de esta lección hecha norma: cambió el cómo —del patrón a la cooperativa— y se sostuvo el para qué, que era el trabajo.

### La palanca

El kit de emergencia de esta lección se arma mejor con gente que ya cruzó un valle. Buscá una cooperativa de trabajo de tu zona —muchas atienden al público: imprentas, panaderías, gráficas, frigoríficos— y pedí una charla corta con alguien que esté desde el principio. Llevá dos preguntas: qué casi los hizo abandonar y qué tuvieron que cambiar para no hacerlo.
Anotá las respuestas en tu kit de emergencia, al lado de tus propias prácticas.

### El puente

[PLANTALLER](/planes/plantaller) toma a las fábricas recuperadas, y a Zanón por su nombre, como prueba de que producir en colectivo aguanta: lo que las sostiene, dice, es infraestructura compartida, un colectivo de apoyo y método.
