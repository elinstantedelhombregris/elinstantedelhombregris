---
slug: los-enemigos-internos-de-la-vision
courseSlug: la-vision-de-transformacion
title: Los Enemigos Internos de la Visión
summary: 'Creencias limitantes, síndrome del impostor, zona de confort y distorsiones cognitivas. Cómo identificar y desactivar lo que te frena.'
orderIndex: 4
estimatedMinutes: 11
draft: false
---
...
Creencias limitantes, síndrome del impostor, zona de confort y distorsiones cognitivas. Cómo identificar y desactivar lo que te frena. Cobra valor cuando lo convertís en una decisión observable dentro de tu visión personal y tu capacidad de sostenerla. El objetivo no es repetir una definición, sino usar esta idea para leer mejor una situación, ordenar prioridades y elegir un siguiente paso con menos improvisación.
