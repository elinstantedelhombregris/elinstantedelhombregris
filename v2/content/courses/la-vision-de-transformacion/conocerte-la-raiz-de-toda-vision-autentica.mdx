---
slug: conocerte-la-raiz-de-toda-vision-autentica
courseSlug: la-vision-de-transformacion
title: 'Conocerte: La Raíz de Toda Visión Auténtica'
summary: 'Autoconocimiento profundo como base no negociable. Jung, la Ventana de Johari, excavación de valores y guiones de vida.'
orderIndex: 2
draft: false
cierre: puente
---
...
La excavación de valores desconfía del relato que cada uno tiene sobre sí mismo. [Conocerse sin espejo](/ensayos/conocerse-sin-espejo) parte de la misma sospecha —en el país que más se analiza, el relato puede funcionar como pantalla— y la lleva a la política: una república sólo es adulta si sus ciudadanos también lo son.
