---
slug: planificacion-estrategica-con-alma
courseSlug: la-vision-de-transformacion
title: Planificación Estratégica con Alma
summary: 'Teoría del Cambio, backcasting, OKRs con propósito y pensamiento sistémico para transformar visión en acción.'
orderIndex: 8
draft: false
cierre: completo
fuentes:
  - url: https://servicios.infoleg.gob.ar/infolegInternet/anexos/250000-254999/253626/norma.htm
    titulo: 'Ley 27.191 — Régimen de Fomento de Energías Renovables (InfoLeg)'
    consultada: '2026-09-22'
  - url: https://econojournal.com.ar/2026/02/las-energias-renovables-sumaron-mas-de-1-000-mw-en-2025-y-ya-cubren-casi-un-quinto-de-la-demanda/
    titulo: 'EconoJournal — Las energías renovables sumaron más de 1.000 MW en 2025 y ya cubren casi un quinto de la demanda'
    consultada: '2026-09-22'
  - url: https://donellameadows.org/archives/leverage-points-places-to-intervene-in-a-system/
    titulo: 'Donella Meadows — Leverage Points: Places to Intervene in a System (Donella Meadows Project)'
...
Donella Meadows, pionera del pensamiento sistémico, nos enseñó que **los problemas complejos no se resuelven atacando síntomas, sino interviniendo en los puntos de apalancamiento del sistema**: los lugares donde un cambio chico en una cosa produce cambios grandes en todo lo demás.
...
2. **Identificá los ciclos viciosos**: ¿qué se refuerza a sí mismo en tu contra? (ej: trabajar mucho → estrés → mala alimentación → poca energía → más estrés)
...
La Ley 27.191, sancionada el 23 de septiembre de 2015, es un backcasting con fuerza de ley. Su artículo 5 fija el punto de llegada: que las fuentes renovables cubran el 20% del consumo eléctrico nacional al 31 de diciembre de 2025. El artículo 8 camina para atrás y les pone escalones obligatorios a los grandes usuarios: 8% a fines de 2017, 12% en 2019, 16% en 2021, 18% en 2023. Diez años y varios gobiernos después, en diciembre de 2025 las renovables cubrieron el 19,6% de la demanda eléctrica, según datos de CAMMESA que publicó EconoJournal, y ese año se sumaron 1.010 MW nuevos. No llegó exacto. Pero se sabe cuánto faltó, y se sabe porque los hitos estaban escritos de antemano.

### La palanca

Hacé con tu visión lo que hizo la Ley 27.191: escribí el punto de llegada con fecha y después bajá, escalón por escalón, hasta este trimestre. Si tu mapa apunta a 2029, poné dónde tenés que estar a fines de 2028, de 2027 y en diciembre de este año. Cada escalón tiene que poder medirse sin discusión.
Dibujá la escalera en una hoja, con fechas, empezando por el último escalón.

### El puente

[PLANEN](/planes/planen) razona hacia atrás desde después de 2045, cuando espera que caiga la demanda mundial de gas y la matriz ya tenga que ser renovable. Y con el CAREM cuenta lo que le pasa a un plan largo sin paciencia: cada cambio de gobierno le discutió el financiamiento.
