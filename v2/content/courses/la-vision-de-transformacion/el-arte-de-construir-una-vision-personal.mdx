---
slug: el-arte-de-construir-una-vision-personal
courseSlug: la-vision-de-transformacion
title: El Arte de Construir una Visión Personal
summary: 'Proceso guiado para crear tu visión. Ikigai adaptado, declaración de visión personal y técnica de anclaje emocional.'
orderIndex: 3
draft: false
cierre: puente
---
...
Escribir la visión en presente, como si ya la estuvieras viviendo, tiene un antecedente largo en la biblioteca: [Carta al nieto](/ensayos/carta-al-nieto) le habla a alguien que todavía no nació desde adentro del país que ya se hizo, no desde las ganas de hacerlo.
