---
slug: agere-la-etimologia-de-la-accion
courseSlug: accion-comunitaria
title: Agere — La etimología de la acción
summary: 'De dónde viene la palabra "acción", qué significa ser agente, y por qué reaccionar no es lo mismo que actuar.'
orderIndex: 1
estimatedMinutes: 9
draft: false
---
...
De dónde viene la palabra "acción", qué significa ser agente, y por qué reaccionar no es lo mismo que actuar. Cobra valor cuando lo convertís en una decisión observable dentro de tu proyecto, tu barrio y tu capacidad de organizarte. El objetivo no es repetir una definición, sino usar esta idea para leer mejor una situación, ordenar prioridades y elegir un siguiente paso con menos improvisación.
