---
slug: modulo-3-juegos-repetidos-e-iterados
courseSlug: teoria-juegos-argentina-hombre-gris
title: Módulo 3 · Juegos repetidos e iterados
summary: 'Explora cómo la repetición, el descuento y la memoria cambian los incentivos.'
orderIndex: 3
estimatedMinutes: 12
draft: false
---
...
3. Identifica qué variables podés modificar para subir δ (duración, reputación, beneficios futuros).
...
Explora cómo la repetición, el descuento y la memoria cambian los incentivos. Cobra valor cuando lo convertís en una decisión observable dentro de tu vida, tu comunidad y la transformación argentina. El objetivo no es repetir una definición, sino usar esta idea para leer mejor una situación, ordenar prioridades y elegir un siguiente paso con menos improvisación.
