...
7. Adelantar la devolución del IVA a Fase 1 (primer viernes de 2029) y costearla en el Libro Mayor. Hoy el primer beneficio concreto para una persona real es 2032, y el IVA que Vuelve no está costeado: ~7,5M de hogares × USD 31–52/mes = **USD 2.800–4.700M/año (0,56–0,94% del PBI)**, cuatro a siete veces el presupuesto declarado del PLAN entero.
8. Escribir lo que falta: LA MASA; la sustitución de IIBB completa (origen, destino, modelo HST, Comisión Arbitral como sala técnica del CFF — hoy tiene cero menciones en el taller); las **detracciones pre-coparticipación** (cero ocurrencias en 46.234 líneas: la Fórmula reparte con precisión quirúrgica una masa que se vacía arriba); el dueño y la auditoría del padrón (el que cuenta cobra por lo que cuenta); la fila de `READINESS_GATES_ADVERSARIAL.md`; la sección de compatibilidad con regímenes de estabilidad. **Ojo con el RIGI:** el corpus sí lo nombra —PLANTER le dedica una falla entera, PLANEN lo cita, `CASCADA_LEGAL_BASTA.md` tiene su ley de derogación y `READINESS_GATES_ADVERSARIAL.md` lo lleva en la fila de PLANTER—, así que PLANPACTO **no estrena posición**: agrega el inventario de compromisos y devuelve el riesgo ISDS al gate de PLANTER, que ya lo tenía; y el mapa de perdedores, que hoy no incluye a los gremios de las 25 administraciones tributarias ni a los consejos profesionales de ciencias económicas.
