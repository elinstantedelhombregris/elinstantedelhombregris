...
- ~~El tope del **8%** que PLANARCO le pide~~ — **retirado el 2026-08-01 por la Task 11, con razón.** El tope **no existe en PLANARCO**: cero ocurrencias de `8%`, y `§4.4` (`:437`) **declina el FGS entero** contra el propio interés, cosa que `§11` (`:883`) repite. Escribirlo habría estrenado una cifra **contradiciendo dos secciones del documento que la nota viene a representar**. Vivía sólo en la spec y en este plan. Lo que se escribe en su lugar es lo que sí se sostiene: que el reclamo de PLAN24CN pasa a competir con uno que tiene materia y organismo, y que ARCO declinó.
