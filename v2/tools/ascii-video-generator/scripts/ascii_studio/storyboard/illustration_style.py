...
GRABADO_CIVICO = IllustrationStyleProfile(
    ...
    composition=(
        ...
        "evitar un retrato heroico central: los cuerpos son anónimos, colectivos y de escala equivalente",
    ),
    palette=(
        "tinta negra dominante con línea tallada, rayado y trama manual",
        "papel crema/ocre envejecido como segundo tono dominante",
        "tinta cobalto-índigo fría #4059C7, más azul que violeta, reservada para relaciones, recorridos, redes y alternativas",
    ...
    forbidden=(
        ...
        "cualquier parecido reconocible con dirigentes, candidatos, celebridades o figuras públicas reales",
        "peinados, patillas, gestos, trajes, poses o rasgos faciales asociados a líderes políticos contemporáneos",
        "un varón carismático central, un salvador, un candidato o una figura individual dominante",
        "iconografía, consignas, colores, banderas o emblemas de partidos políticos reales",
        "cobalto-índigo o rojo usados como relleno masivo sin función semántica",
