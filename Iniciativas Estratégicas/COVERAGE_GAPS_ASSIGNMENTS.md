...
> ¹ **Retirado 2026-07-26.** Este hueco pasa a tener PLAN propio y deja de ser
> sub-mandato — ver `ACTA_LEVANTAMIENTO_FREEZE_2026-07-26.md`, sección «Lo que
> se levanta y lo que no». Se conserva el renglón para que quede legible por qué
> se había asignado como sub-mandato y a quién.
>
> ² **Retirado en parte, 2026-07-26.** Sólo la porción de **vejez** de este hueco
> se retira y pasa a tener PLAN propio (PLANARCO). La porción de **discapacidad**
> no se retira: sigue asignada a PLANCUIDADO + PLANSAL como sub-mandato, sin
> cambios. Ver `ACTA_LEVANTAMIENTO_FREEZE_2026-07-26.md`, sección «Lo que se
> levanta y lo que no».
