...
import { buildCivicIntelligence } from './civic/intelligence';
import {
...
export function registerCivicIntelligenceRoutes(app: Express): void {
  app.get('/api/v1/civic/intelligence', publicReadRateLimit, async (req, res) => {
    ...
    try {
      ...
      return res.status(500).json({
        ...
        message: 'La lectura para decisiones todavía no pudo actualizarse.',
      });
    }
  });
}
