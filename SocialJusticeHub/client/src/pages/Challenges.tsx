    ...
    return (
      <div className="min-h-screen bg-[#0a0a0a] text-slate-200 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-slate-500 mt-2 font-mono text-sm uppercase tracking-widest">Credenciales de Agente Requeridas</p>
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-8">
            <div className="text-left">
              ...
              <p className="text-lg text-slate-400 font-light max-w-2xl leading-relaxed">
                Ejecuta protocolos de entrenamiento para expandir tu influencia sistémica y desbloquear nuevas capacidades operativas.
              </p>
            </div>
            ...
            <div className="flex gap-4">
              ...
              <Card className="bg-white/5 border-white/10 backdrop-blur-md w-32">
                <CardContent className="p-4 text-center">
                  ...
                  <div className="text-[10px] uppercase tracking-widest text-emerald-400 font-bold mt-1">Completadas</div>
                </CardContent>
              </Card>
            </div>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        {challengesLoading ? (
          <div className="flex flex-col items-center justify-center py-20">
            ...
            <p className="text-purple-400 font-mono text-sm animate-pulse">CARGANDO BASE DE DATOS DE MISIONES...</p>
          </div>
          ...
          <div className="text-center py-20 bg-white/5 border border-white/10 rounded-xl backdrop-blur-sm">
            ...
            <h3 className="text-xl font-serif text-slate-300 mb-2">No se encontraron protocolos</h3>
            <p className="text-slate-500 font-light">Ajusta los filtros de búsqueda para localizar nuevas misiones.</p>
            <Button 
              variant="outline" 
              onClick={() => {
                setSearchTerm('');
                      ...
                      <div>
                        ...
                        {!isAvailable && (
                          <span className="text-xs text-red-400 font-mono flex items-center mt-1">
                            <Lock className="w-3 h-3 mr-1" /> ACCESO BLOQUEADO - REQUIERE NIVEL {level}
                          </span>
                        )}
                      </div>
                    </div>
                                  ...
                                  {isLocked ? (
                                    ...
                                    <Link href={`/challenges/${challenge.id}`}>
                                      <Button className={cn(
                                        ...
                                        {isInProgress ? "CONTINUAR PROTOCOLO" : "INICIAR MISIÓN"}
