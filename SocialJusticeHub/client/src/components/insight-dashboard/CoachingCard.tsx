...
export default function CoachingCard({ hasProfile }: Props) {
  return (
    <Card className="bg-white/5 backdrop-blur-md border-white/10 overflow-hidden relative">
      <div className="absolute -right-8 -top-8 w-32 h-32 bg-[#7D5BDE]/10 rounded-full blur-2xl" />
      <CardContent className="py-6 relative z-10">
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            <h3 className="text-sm font-bold text-slate-200 uppercase tracking-wider mb-1">Coaching Civico</h3>
            ...
            <Link href={hasProfile ? '/coaching' : '/evaluacion'}>
              <Button size="sm" className="bg-[#7D5BDE] hover:bg-[#8D6FE4] text-white text-xs font-bold uppercase tracking-wider">
