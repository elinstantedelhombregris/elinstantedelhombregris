...
export const inspiringStories = pgTable("inspiring_stories", {
  id: serial("id").primaryKey(),
  title: text("title").notNull(),
...
export const communityPostInteractions = pgTable("community_post_interactions", {
  id: serial("id").primaryKey(),
...
export const communityPostActivity = pgTable("community_post_activity", {
  id: serial("id").primaryKey(),
  postId: integer("post_id").references(() => communityPosts.id),
...
export const textEmbeddings = pgTable("text_embeddings", {
  ...
  embedding: text("embedding"), // Blob para vector de embeddings
...
export const postComments = pgTable("post_comments", {
  ...
  postId: integer("post_id").references(() => blogPosts.id),
  userId: integer("user_id").references(() => users.id),
  parentId: integer("parent_id").references((): AnyPgColumn => postComments.id), // Para replies
  content: text("content").notNull(),
  createdAt: text("created_at").default(sql`now()`),
  updatedAt: text("updated_at").default(sql`now()`),
});
...
export const courses = pgTable("courses", {
  ...
  requiresAuth: boolean("requires_auth").default(false), // Si requiere autenticación
  authorId: integer("author_id").references(() => users.id),
  viewCount: integer("view_count").default(0),
  createdAt: text("created_at").default(sql`now()`),
  updatedAt: text("updated_at").default(sql`now()`),
...
export const provinceRankings = pgTable("province_rankings", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
...
export const lifeAreaSubcategories = pgTable("life_area_subcategories", {
  id: serial("id").primaryKey(),
...
// Quizzes por área
export const lifeAreaQuizzes = pgTable("life_area_quizzes", {
  id: serial("id").primaryKey(),
  lifeAreaId: integer("life_area_id").references(() => lifeAreas.id),
  title: text("title").notNull(),
  description: text("description"),
...
// Preguntas del quiz
export const lifeAreaQuizQuestions = pgTable("life_area_quiz_questions", {
  id: serial("id").primaryKey(),
...
export const lifeAreaQuizResponses = pgTable("life_area_quiz_responses", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
  quizId: integer("quiz_id").references(() => lifeAreaQuizzes.id),
...
export const lifeAreaScores = pgTable("life_area_scores", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
  lifeAreaId: integer("life_area_id").references(() => lifeAreas.id),
  subcategoryId: integer("subcategory_id").references(() => lifeAreaSubcategories.id),
...
export const lifeAreaActions = pgTable("life_area_actions", {
  id: serial("id").primaryKey(),
  lifeAreaId: integer("life_area_id").references(() => lifeAreas.id),
  subcategoryId: integer("subcategory_id").references(() => lifeAreaSubcategories.id),
  title: text("title").notNull(),
...
export const userLifeAreaProgress = pgTable("user_life_area_progress", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
...
export const lifeAreaMilestones = pgTable("life_area_milestones", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
  lifeAreaId: integer("life_area_id").references(() => lifeAreas.id),
  title: text("title").notNull(),
...
export const lifeAreaIndicators = pgTable("life_area_indicators", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
  lifeAreaId: integer("life_area_id").references(() => lifeAreas.id),
...
export const lifeAreaCommunityStats = pgTable("life_area_community_stats", {
  id: serial("id").primaryKey(),
  lifeAreaId: integer("life_area_id").references(() => lifeAreas.id),
...
export const lifeAreaXpLog = pgTable("life_area_xp_log", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
  lifeAreaId: integer("life_area_id").references(() => lifeAreas.id),
...
export const lifeAreaLevels = pgTable("life_area_levels", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
  lifeAreaId: integer("life_area_id").references(() => lifeAreas.id),
...
// Rachas del usuario
export const lifeAreaStreaks = pgTable("life_area_streaks", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
...
export const lifeAreaBadges = pgTable("life_area_badges", {
  id: serial("id").primaryKey(),
  name: text("name").notNull(),
  description: text("description").notNull(),
  iconName: text("icon_name").notNull(),
...
export const userLifeAreaBadges = pgTable("user_life_area_badges", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
...
export const lifeAreaCurrency = pgTable("life_area_currency", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id).unique(),
...
export const lifeAreaRewardChests = pgTable("life_area_reward_chests", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
...
// Desafíos especiales
export const lifeAreaChallenges = pgTable("life_area_challenges", {
  id: serial("id").primaryKey(),
...
export const userLifeAreaChallenges = pgTable("user_life_area_challenges", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
...
// Maestría por área
export const lifeAreaMastery = pgTable("life_area_mastery", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
  lifeAreaId: integer("life_area_id").references(() => lifeAreas.id),
...
export const lifeAreaNotifications = pgTable("life_area_notifications", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
...
export const lifeAreaSocialInteractions = pgTable("life_area_social_interactions", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
...
export const civicAssessments = pgTable("civic_assessments", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
...
export const civicAssessmentResponses = pgTable("civic_assessment_responses", {
  id: serial("id").primaryKey(),
...
export const civicProfiles = pgTable("civic_profiles", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
  assessmentId: integer("assessment_id").references(() => civicAssessments.id),
...
// Civic goals
export const civicGoals = pgTable("civic_goals", {
  id: serial("id").primaryKey(),
  userId: integer("user_id").references(() => users.id),
  title: text("title").notNull(),
  description: text("description"),
