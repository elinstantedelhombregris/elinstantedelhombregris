...
export const DEPENDENCIES: Dependency[] = [
  ...
  { id: 'd200', kind: 'provides', source: 'PLANPREGUNTA', target: 'PLANGEO', nature: 'MINOR', type: 'INSTITUTIONAL', description: 'El método como módulo del Stack de Soberanía a partir de 2040: open-source, forkeable y con cero lock-in, como `PLANGEO:209` exige de todo módulo. No se exporta el conocimiento sino la manera de administrar la ignorancia propia' },
